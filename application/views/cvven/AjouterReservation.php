...
<html>
    ...
    <body>
        <?php
        echo form_open('Reservations/formulaireReservationAdmin');
        ?>
        <div align='center'>
        ...
        <form>
            ...
            <?php
                ...
                echo '<option value="0" selected="selected">Sélectionnez l\'utilisateur</option>';
                foreach ($utilisateur as $news_util):
                    echo "<option value=\"" . $news_util['idUtil'] . " \">" . $news_util['idUtil'] . " (" . $news_util['Prenom'] . " " . $news_util['Nom'] . ")</option>";
                endforeach;
                echo '</select>';
                ?>
            <br/>
